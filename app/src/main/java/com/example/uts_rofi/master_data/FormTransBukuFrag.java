...
import com.example.uts_rofi.adapter.AdaptarDetailTransaksi;
 ...
 * Use the {@link FormTransBukuFrag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FormTransBukuFrag extends Fragment {
    Context context;
    ...
    public static FormTransBukuFrag newInstance(String param1, String param2) {
        FormTransBukuFrag fragment = new FormTransBukuFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Global.rcViewTransBukuDetail.setAdapter(new AdaptarDetailTransaksi(this));
        ...
        btnAddTransDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Global.PergiKe(new ViewBukuFrag());
            }
        });
                ...
                new AlertDialog.Builder(Global.activity)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                db.insertData(DBHelper.table_transaksi_buku, values);
                                ...
                                Global.PergiKe(new ViewTransBukuFrag());
                            }
                        })
