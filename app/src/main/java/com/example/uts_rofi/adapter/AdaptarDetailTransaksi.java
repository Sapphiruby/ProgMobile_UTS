...
public class AdaptarDetailTransaksi extends RecyclerView.Adapter<AdaptarDetailTransaksi.ViewHolder> {
    private List<DetailTransaksiEntity> list;
    private FormTransBukuFrag fragment;
    ...
    public AdaptarDetailTransaksi(FormTransBukuFrag paramFragment) {
