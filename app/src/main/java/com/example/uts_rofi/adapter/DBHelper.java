...
public class DBHelper extends SQLiteOpenHelper {
    public static final String database_name = "db_gallatea";
    ...
    public static final String table_transaksi_buku = "table_transaksi";
    ...
    public void EnsureTableCreated(SQLiteDatabase db) {
        ...
        if (!CheckTableExist(table_transaksi_buku, db)) {
            query += "CREATE TABLE " + table_transaksi_buku + "("
    ...
    public String GetMaxIdTransaction() {
        String query = String.format("SELECT " + DBHelper.trans_buku_id + " FROM " + DBHelper.table_transaksi_buku + " order by " + DBHelper.trans_buku_id + " desc");
    ...
    public List<TransBukuEntity> getAllTransBuku() {
        ...
        String query = String.format("SELECT * FROM " + DBHelper.table_transaksi_buku);
    ...
    @SuppressLint("Range")
    public List<DetailTransaksiEntity> getAllTransBukuDetailByIdTransBuku(String transid) {
        List<DetailTransaksiEntity> listTransDetailBuku = new ArrayList<DetailTransaksiEntity>();
        ...
        try {
            if (cursor.moveToFirst()) {
                do {
                    DetailTransaksiEntity transDetailBuku = new DetailTransaksiEntity();
